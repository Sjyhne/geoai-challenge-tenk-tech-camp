...
2. Pakk ut denne ZIP-filen på nytt.
3. Start applikasjonen fra den nye mappen.

Denne pakken inneholder kontrollert:
- Finn område har gratis Kartverket-søk etter norske adresser og stedsnavn.
- Kartet deltakerne tegner i har samme kvadratiske format som PNG-bildet som lastes ned til WebSAM.
- Rekkefølgen er endret til: finn område, bygg kart, bruk KI, se resultat.
